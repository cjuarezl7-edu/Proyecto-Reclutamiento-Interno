...
function Ordenes() {
  ...
  const MetodoInsertar = async () => {
    try {
      await axios.post("https://apptualizate.net/ApiDemo/api/Orden", formulario);
      const response = await axios.get("https://apptualizate.net/ApiDemo/api/Orden");
  ...
  const MetodoActualizar = async () => {
    try {
      ...
      await axios.put(`https://apptualizate.net/ApiDemo/api/Orden/${id}`, formulario);
      const response = await axios.get("https://apptualizate.net/ApiDemo/api/Orden");
      setOrdenes(response.data);
      handleClose();
      openSuccessSB();
  ...
  useEffect(() => {
    ...
    const fetchProveedores = async () => {
      try {
        ...
        setProveedores(response.data); // Almacenar los proveedores
      } catch (error) {
    ...
    fetchData();
    fetchProveedores(); // Llamar a la función para obtener los proveedores
  }, []);
