  ...
  return (
    <DashboardLayout>
      ...
      <Dialog open={openInsert} onClose={handleCloseInsert}>
        <DialogTitle>{isEditing ? "Actualizar Empleado" : "Insertar Empleado"}</DialogTitle>
        <DialogContent
          style={{
            backgroundColor: "#E0F7FA", // Fondo celeste más suave
          ...
          <Grid container spacing={2}>
            <Grid item xs={6}>
              <TextField
                ...
                style={{ backgroundColor: "#FFFDE7", borderRadius: "5px" }} // Fondo blanco suave
              />
            </Grid>
            <Grid item xs={6}>
              <TextField
        ...
        <DialogActions>
          <Button onClick={handleCloseInsert} style={{ color: "black" }}>
            Cancelar
          </Button>
