...
function Tables() {
  ...
  const MetodoInsertar = async () => {
    try {
      ...
      await axios.post("https://apptualizate.net/ApiDemo/api/Proveedor", datosAEnviar); // Inserta usando la API
      const response = await axios.get("https://apptualizate.net/ApiDemo/api/Proveedor"); // Actualiza la tabla
  ...
  const MetodoActualizar = async () => {
    try {
      ...
      const url = `https://apptualizate.net/ApiDemo/api/Proveedor/${id}`;
  ...
  const handleDelete = async () => {
    try {
      ...
      await axios.delete(`https://apptualizate.net/ApiDemo/api/Proveedor/${id}`); // Elimina el proveedor usando la API
      const response = await axios.get("https://apptualizate.net/ApiDemo/api/Proveedor"); // Actualiza la tabla
